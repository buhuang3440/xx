    ...
    <drawer id="drawer">
        <vertical>
            ...
            <viewpager id="viewpager">
                ...
                <ScrollView>
                    <frame>
                    <img src={"https://vkceyugu.cdn.bspapp.com/VKCEYUGU-fc6781eb-b272-4a5f-b63b-5f95b1ebb435/b060e6cb-8887-47be-8525-50d9b05be865.png" } scaleType="centerCrop" alpha="0.55" />
                        <vertical id="ttxs_pro" gravity="center">
                            ...
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                ...
                                <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                    ...
                                    <text w="auto" textColor="#004b50" textSize="12sp" text="使用前确保所有账号都已完成短信验证" />
                                    <text w="auto" textColor="#004b50" textSize="12sp" text="账号1:密码1:token1(换行/回车)账号2:密码2:token2(换行/回车)账号3:密码3:token3" />
...
ui.start.click(function () {
    ...
    threads.start(function () {
        toastLog("脚本加载中，请稍后...")
        var link = "https://gitee.com/xz0816/ttxs_auto/raw/master/info.json-master/xxqg.js"
