...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="自动学习Pro-免费使用"/>
                ...
                <img src={"https://app.livemz.cn/pics/api.php" } scaleType="centerCrop" alpha="0.55" />
                    <vertical>
						...
						<button h="70" id="start" text="开始学习" textSize="25sp" color="#000000" bg="#FF4FB3FF" foreground="?selectableItemBackground"   alpha="0.55"/>
                            ...
                            <button h="50"  id="join_QQ" text="联系反馈" textSize="18sp" color="#000000" bg="#bfbfbf" foreground="?selectableItemBackground"  alpha="0.55"/>
                    ...
                    <img src={"https://vkceyugu.cdn.bspapp.com/VKCEYUGU-fc6781eb-b272-4a5f-b63b-5f95b1ebb435/399e4210-8286-483c-b7b3-d51978eabd49.jpg" } scaleType="centerCrop" alpha="0.55" />
                        <vertical id="ttxs_pro" gravity="center">
                            ...
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                <View bg="#00BFFF" h="*" w="10"  ></View>
                                <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                    <text w="auto" textColor="#222222" textSize="15sp" text=" " />
                                </vertical>
