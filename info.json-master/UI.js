                        ...
                        <vertical id="ttxs_pro" gravity="center">
                            ...
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                ...
                                <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                    ...
                                    <spinner id="ttxs_pro_meizhou" marginLeft="4" marginRight="6" entries="正序答题|最近一次已作答开始倒序|不做" />
                                </vertical> 
                            </horizontal>
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                <View bg="#00BFFF" h="*" w="10"  ></View>
                                <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                    ...
                                    <spinner id="ttxs_pro_zhuanxiang" marginLeft="4" marginRight="6" entries="正序答题|最近一次已作答开始倒序|不做" />
                                </vertical> 
                            </horizontal>
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                <View bg="#00BFFF" h="*" w="10"  ></View>
